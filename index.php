   ...
   <section class="featured">
    <div class="container featured__container">
      <div class="post__thumbnail">
        <img src="./images/people-centered-care-wcd2025.jpg.webp" alt="Image principale de l'article">
      </div>
      <div class="post__info">
        <a href="category-posts.php" class="category__button">Wild Life</a>
        <h2 class="post__title"><a href="./post.php">Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam?</a></h2>
        <p class="post__body">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ab obcaecati possimus ipsa totam rem, at velit minima dolorem maiores corporis veritatis, saepe eum delectus quo ipsam nisi? Corrupti, odit debitis!</p>
        <div class="post__author">
          <div class="post__author-avatar">
            <img src="./images/download.jpg" alt="Avatar de Frank Kamgang">
          </div>
          <div class="post__author-info">
            <h5>Par: Frank Kamgang</h5>
            <small>7 Avril 2025 - 12:20</small>
          </div>
        </div>
      </div>
    </div>
